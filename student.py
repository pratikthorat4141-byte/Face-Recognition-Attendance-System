...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","COMPUTER Engineering","AIML Engineering","AIDS Engineering","ENTC Engineering","ELECTRICAL Engineering","MECHANICAL Engineering","CIVIL Engineering")
        dep_combo.current(0)
